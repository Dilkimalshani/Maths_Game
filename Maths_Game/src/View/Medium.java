...
public String questionId="1";
     ...
     public void question()
    {
        try
        {
          ...
          ResultSet rs1=st.executeQuery("select *from medium where id='"+questionId+"'");
          while(rs1.next())
          {
      ...
      public void submit()
    {
         // String name=jLabel8.getText();
          ...
          try
          {
            Connection con=ConnectionSet.getCon();
            Statement st=con.createStatement();
            //st.executeUpdate("update user set marks='"+marks+"' where username='"+name+"' ");
            String marks1=String.valueOf(marks);
            setVisible(false);
 ...
 Timer time;
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Two numbers in ratio 4:5.if the sum of the numbers is 135 , find the number");

        jRadioButton1.setText("60 and 70");
        ...
        jRadioButton2.setText("50 and 65");
        ...
        jRadioButton3.setText("70 and 95");
        ...
        jRadioButton4.setText("65 and 75");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(223, 291, Short.MAX_VALUE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 770, 350));
        ...
        setSize(new java.awt.Dimension(844, 539));
